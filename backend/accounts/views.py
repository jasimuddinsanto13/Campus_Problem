...
# The frontend calls these with fetch() + credentials:'include' so the
# session cookie is set cross-origin. CSRF is exempt because this is the
# authentication entry point (no existing session/token to protect).
# ---------------------------------------------------------------------------
